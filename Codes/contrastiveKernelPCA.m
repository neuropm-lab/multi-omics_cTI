...
% Clustering
rng('default'); Ci = GCSpectralClust1(affinity_matrix,10); Kbst=CNDistBased(Ci,affinity_matrix); Ci = Ci(:,Kbst); % If using instead the Community Detection Toolbox (from http://users.auth.gr/~kehagiat/Software/)
